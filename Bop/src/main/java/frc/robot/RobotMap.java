...
public class RobotMap {
  ...
  public class Constants {
    ...
    public class Shooter {
      ...
      public static final double IN_SHOOT   = 0.80f;
      public static final double DEAD_PWR   = 0.00f;
      public static final double OUT_SHOOT  =-0.20f;
    }
    public class Wrist {
    ...
    public class Elevator {
      public static final double DOWN_POS     = 100f;
      ...
      public static final double TWO_UP_POS   = 100f;
    }
  ...
  public class Motors {
    ...
    public static final int WRIST_R = 2;
    public static final int WRIST_L = 3;

    public static final int INTAKE = 4;

    public static final int CONVEYOR_BACK = 6;
    public static final int CONVEYOR_FRONT = 7;

    public static final int SHOOTER_TOP = 8;
    public static final int SHOOTER_BOT = 9;

    public static final int STAGEONE = 10;
    public static final int STAGETWO = 11;
